require([
    ...
    "dojo/_base/unload", "dojo/cookie", "dojo/json", "esri/IdentityManager",
     "esri/toolbars/navigation", "dijit/registry", "dojo/on",

"esri/map", "esri/dijit/OverviewMap", "esri/layers/FeatureLayer", "esri/dijit/AttributeInspector", "esri/symbols/SimpleLineSymbol", "esri/symbols/SimpleFillSymbol",
"esri/Color", "esri/layers/ArcGISDynamicMapServiceLayer", "esri/layers/ImageParameters", "esri/layers/ArcGISTiledMapServiceLayer",
 "esri/tasks/query", "dojo/query", "dojo/parser", "dojo/dom-construct", "dijit/form/Button", "esri/tasks/GeometryService",
"esri/geometry/Point", "esri/tasks/ProjectParameters", "esri/SpatialReference", "esri/tasks/QueryTask", "esri/layers/GraphicsLayer",
"esri/geometry/Extent", "esri/geometry/Polygon", "esri/dijit/HomeButton", "esri/symbols/SimpleMarkerSymbol", "esri/graphic",
"esri/dijit/Scalebar", "esri/arcgis/utils", "esri/dijit/LayerList", "esri/dijit/editing/TemplatePicker", "esri/dijit/Legend",
"esri/dijit/editing/Editor", "dojo/i18n!esri/nls/jsapi", "dojo/keys", "dojo/_base/array", "dojo/dom", "dgrid/OnDemandGrid", "esri/dijit/Measurement",
 "dgrid/Selection", "dojo/store/Memory", "dojo/_base/declare", "esri/dijit/Print", "esri/tasks/PrintTemplate", "esri/request", "esri/config",
  "esri/geometry/geometryEngine", "esri/InfoTemplate", "dijit/Toolbar", "dijit/layout/BorderContainer", "dijit/layout/ContentPane", "dojo/domReady!"
], function (
    baseUnload, cookie, JSON, esriId, Navigation, registry, on,
Map, OverviewMap, FeatureLayer, AttributeInspector, SimpleLineSymbol, SimpleFillSymbol, Color, ArcGISDynamicMapServiceLayer, ImageParameters,
ArcGISTiledMapServiceLayer, Query, dojoQuery, parser, domConstruct, Button, GeometryService, Point, ProjectParameters,
SpatialReference, QueryTask, GraphicsLayer, Extent, Polygon, HomeButton, SimpleMarkerSymbol, Graphic, Scalebar, arcgisUtils,
LayerList, TemplatePicker, Legend, Editor, jsapiBundle, keys, array, dom, Grid, Measurement, Selection, Memory, declare, Print, PrintTemplate, esriRequest, esriConfig,
         geometryEngine, InfoTemplate
) {
    ...
    var printUrl = "http://112.78.4.175:6080/arcgis/rest/services/Utilities/PrintingTools/GPServer/Export%20Web%20Map%20Task";
